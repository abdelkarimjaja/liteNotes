            ...
            <div class="flex">
                @if (!$note->trashed())
                    ...
                    <form action="{{ route('notes.destroy', $note) }}" method="post">
                        ...
                        <button type="submit" class="btn btn-danger ml-4" onclick="return confirm('Are sure you wish this note to trash /')">Move to Trash</button>
                    </form>
                @else
                    <p class="opacity-70">
                    ...
                    <form action="{{ route('trashed.destory', $note) }}" method="post">
                        @method('delete')
                        @csrf

                        <button type="submit" class="btn btn-danger ml-4" onclick="return confirm('Are you sure you wish delete this note forever? This action cannot be undone')">Delete Forever</button>
                    </form>
